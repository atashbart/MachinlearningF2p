# ==================================================
# Logistic Regression F1-score Analysis (FINAL)
# Dataset: F2BCMS.csv
...
print("=== Logistic Regression F1-score Analysis ===")
...
# -------------------------------------------------
# 6. Logistic Regression over different C values
# -------------------------------------------------
...
plt.axvline(
    ...
    color="green",
    linewidth=2,
    label=f"Optimal C = {optimal_C:.3g}"
)
...
plt.xlabel("Regularization Strength (C)", fontsize=12, fontweight="bold")
...
plt.savefig("logreg_f1_score_analysis.pdf", dpi=300, bbox_inches="tight")
plt.savefig("logreg_f1_score_analysis.png", dpi=300, bbox_inches="tight")
plt.show()
...
print(f"Optimal C                : {optimal_C:.4g}")
